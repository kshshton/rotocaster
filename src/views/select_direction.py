...
class SelectDirection:
    ...
    def __update_direction(self, direction: str) -> None:
        self.__context.engine.direction = direction
    ...
    def __render(self, master: CTk) -> None:
        ...
        direction_label.place(relx=self.__relx, rely=next(
        ...
        direction_combobox = CustomComboBox(
            ...
            content=self.__context.engine.direction,
        )
        direction_combobox.place(relx=self.__relx, rely=next(
            vertical_position), anchor="center")
        ...
        save_button = CTkButton(
            ...
            command=lambda: (
                ...
                RunManualMode(master=master, context=self.__context),
            )
        )
