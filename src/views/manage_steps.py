...
class ManageSteps:
    ...
    def __render(self, master: CTk, combobox: CustomComboBox) -> None:
        try:
            assert self.__settings.profiles_manager.active_profile
            active_profile = self.__settings.profiles_manager.active_profile
            ...
            profile_label.place(relx=self.__relx / 3.25, rely=profile_position, anchor="center")
            ...
            steps_label.place(relx=self.__relx / 2.25, rely=steps_position, anchor="center")
